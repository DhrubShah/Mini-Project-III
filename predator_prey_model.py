...
class PredatorPreySimulation:
    ...
    def lotka_volterra(self, X, t, alpha, beta, delta, gamma):
        x, y = X
    ...
    def start_simulation(self):
        ...
        X0 = [prey_initial, predator_initial]

        solution = odeint(self.lotka_volterra, X0, time, args=(alpha, beta, delta, gamma))
